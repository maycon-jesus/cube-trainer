...
async function stopRunning() {
  ...
  elapsed.value = ms
  phase.value = 'idle'
  emits('solve', { ms, scramble: props.scramble, penalty: 'none', createdAt: Date.now(), type: props.type, puzzle: props.puzzle, sessionId: props.sessionId, trainingSetId: props.trainingSetId?? '', algorithmId: props.algorithmId?? '', tagsId: [], annotation: '' })
  emits('stop')
}
